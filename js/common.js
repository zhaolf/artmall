var pTip = function(str){
  $('.pTip').remove();
  $('body').append('<div class="pTip" style="display: none;text-align: center;z-index: 99999;position: fixed;left: 50%;top: 45%;margin-left: -100px;width: 200px;padding: 10px 0;background: rgba(0,0,0,.8);color: #FFF;border-radius: 4px;font-size:13px;"><span></span></div>');
  $('.pTip span').text(str);
